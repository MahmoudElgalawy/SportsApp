...
// MARK: - UpComingEvenApi
struct UpComingEvenApi: Codable {
    let success: Int
...
struct UpComingEvent: Codable {
    ...
    //let fkStageKey, stageName, leagueGroup: JSONNull?
    let fkStageKey: Int?  // This is correct
    let stageName: String? // Updated from Int to String
    let leagueGroup: String? // Updated from Int to String
